    ...
    (function (factory) {
        ...
        $.serializeJSON = {
            ...
            defaultOptions: {
                ...
                parseStringNulls:false,// convert "" to null
            ...
            setupOpts: function (options) {
                ...
                validOpts = ['checkboxUncheckedValue', 'parseNumbers', 'parseBooleans', 'parseNulls','parseStringNulls', 'parseAll', 'parseWithFunction', 'customTypes', 'defaultTypes', 'useIntKeysAsArrayIndex']; // re-define because the user may override the defaultOptions
                for (opt in options) {
                ...
                return {
                    ...
                    parseStringNulls: parseAll || optWithDefault('parseStringNulls'),
            ...
            parseValue: function (valStr, inputName, type, opts) {
                ...
                else if (opts.parseStringNulls && valStr == "") { // auto: null
                    parsedVal = null;
                }
