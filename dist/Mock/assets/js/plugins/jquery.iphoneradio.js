...
(function (document, $, log) {
	...
	$.fn.tzCheckbox = function(options){
		...
		return this.each(function(){
			...
			var checkBox = $('<span>',{
				"class": 'tzCheckBox e-range e-range-sm '+(this.checked?'open checked':''),
			...
			if(originalCheckBox.next().is("span") && (originalCheckBox.next().attr("class")==="tzCheckBox e-range e-range-sm " || originalCheckBox.next().attr("class")==="tzCheckBox e-range e-range-sm open checked")){
