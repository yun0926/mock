/*TMODJS:{"version":4,"md5":"856b3e585c3c73d6dfcdbbccf1fd9629"}*/
template('template/test.add.update.dialog',function($data,$filename
/**/) {
...
$out+=$escape(id);
$out+='"> <div id="testGo"></div> <div class="row"> <div class="col-sm-12"> <div class="form-group"> <label class="col-sm-2 control-label" style="width: 110px;"><span class="red">*</span>用户名:</label> <div class="col-sm-5"> <input class="form-control" type="text" name="username" value="';
$out+=$escape(username);
