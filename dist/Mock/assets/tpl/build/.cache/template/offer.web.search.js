/*TMODJS:{"version":3,"md5":"e319474719e83325595855b4d342f825"}*/
template('template/offer.web.search',function($data,$filename
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,$escape=$utils.$escape,type=$data.type,placeholder=$data.placeholder,$each=$utils.$each,button=$data.button,bt=$data.bt,$index=$data.$index,checkButton=$data.checkButton,item=$data.item,$out='';$out+='<div class="clearfix search-mode" batch=""> <div class="search-normal"> <form class="search-form"> <input type="hidden" name="type" value="';
$out+=$escape(type);
