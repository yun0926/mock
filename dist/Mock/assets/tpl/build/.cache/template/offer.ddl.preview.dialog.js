/*TMODJS:{"version":2,"md5":"05f707d0cc9bf072894b9af0ed3c92e6"}*/
template('template/offer.ddl.preview.dialog',function($data,$filename
/**/) {
...
$out+='</p> </div> </div> <div class="form-group"> <label class="col-xs-2 control-label">APK下载地址：</label> <div class="col-xs-10"> <p class="form-control-static">';
