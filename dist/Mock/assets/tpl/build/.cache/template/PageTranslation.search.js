/*TMODJS:{"version":2,"md5":"9a48372a097ec2305b2dcd82d554ca8a"}*/
template('template/PageTranslation.search',function($data,$filename
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,$escape=$utils.$escape,pageId=$data.pageId,placeholder=$data.placeholder,$each=$utils.$each,button=$data.button,bt=$data.bt,$index=$data.$index,$out='';$out+='<div class="clearfix search-mode" batch=""> <div class="search-normal"> <form class="search-form"> <input type="hidden" name="pageId" value="';
$out+=$escape(pageId);
