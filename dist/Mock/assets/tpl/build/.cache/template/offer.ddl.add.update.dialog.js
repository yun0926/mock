/*TMODJS:{"version":25,"md5":"a4a1e16dd21c0ac5f1d5dd442a41f888"}*/
template('template/offer.ddl.add.update.dialog',function($data,$filename
/**/) {
...
$out+=$escape(stars);
$out+='"> <span class="input-group-addon">星</span> </div> <div class="error"></div> </div> </div> </div> <div class="col-sm-6"> <div class="form-group"> <label class="col-sm-4 control-label" >响应方式:</label> <div class="col-sm-8"> <select name="action" class="form-select"> <option value="download" selected="selected" >download</option> </select> </div> </div> </div> <div class="col-sm-12"> <div class="form-group"> <label class="col-sm-2 control-label" ><span class="red">*</span>APK下载地址:</label> <div class="col-sm-5"> <input class="form-control" type="text" name="actionUrl" value="';
